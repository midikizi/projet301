 ...
 */
final class Version20230706084751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comptes (id INT AUTO_INCREMENT NOT NULL, clients_id INT NOT NULL, numero_compte VARCHAR(255) NOT NULL, solde INT NOT NULL, date_ouvert DATETIME NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_56735801AB014612 (clients_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE depot (id INT AUTO_INCREMENT NOT NULL, compte_id INT NOT NULL, montant INT NOT NULL, date_depot DATETIME NOT NULL, INDEX IDX_47948BBCF2C56620 (compte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pret (id INT AUTO_INCREMENT NOT NULL, clients_id INT NOT NULL, somme INT NOT NULL, INDEX IDX_52ECE979AB014612 (clients_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reset_password_request (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, selector VARCHAR(20) NOT NULL, hashed_token VARCHAR(100) NOT NULL, requested_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7CE748AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE retraits (id INT AUTO_INCREMENT NOT NULL, comptes_id INT NOT NULL, client_id INT NOT NULL, montant INT NOT NULL, date_retrait DATETIME NOT NULL, INDEX IDX_7BB2A03DCED588B (comptes_id), INDEX IDX_7BB2A0319EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tontines (id INT AUTO_INCREMENT NOT NULL, clients_id INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, montant INT NOT NULL, INDEX IDX_DB8BB5EDAB014612 (clients_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE retraits ADD CONSTRAINT FK_7BB2A0319EB6921 FOREIGN KEY (client_id) REFERENCES clients (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE retraits DROP FOREIGN KEY FK_7BB2A0319EB6921');
