 ...
 */
class UserClientsRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(UserClients $entity, bool $flush = false): void
    {
    ...
    public function remove(UserClients $entity, bool $flush = false): void
    {
    ...
    {
        if (!$user instanceof UserClients) {
...
//    /**
//     * @return UserClients[] Returns an array of UserClients objects
//     */
