 ...
 */
class getUserClientsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserClientsRepository' shared autowired service.
     *
     * @return \App\Repository\UserClientsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserClientsRepository.php';

        return $container->privates['App\\Repository\\UserClientsRepository'] = new \App\Repository\UserClientsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
