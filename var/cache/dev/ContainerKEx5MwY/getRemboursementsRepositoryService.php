 ...
 */
class getRemboursementsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RemboursementsRepository' shared autowired service.
     *
     * @return \App\Repository\RemboursementsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RemboursementsRepository.php';

        return $container->privates['App\\Repository\\RemboursementsRepository'] = new \App\Repository\RemboursementsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
