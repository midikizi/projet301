 ...
 */
class getRetraitsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RetraitsRepository' shared autowired service.
     *
     * @return \App\Repository\RetraitsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RetraitsRepository.php';

        return $container->privates['App\\Repository\\RetraitsRepository'] = new \App\Repository\RetraitsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
