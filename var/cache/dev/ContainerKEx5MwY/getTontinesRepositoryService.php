 ...
 */
class getTontinesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TontinesRepository' shared autowired service.
     *
     * @return \App\Repository\TontinesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TontinesRepository.php';

        return $container->privates['App\\Repository\\TontinesRepository'] = new \App\Repository\TontinesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
